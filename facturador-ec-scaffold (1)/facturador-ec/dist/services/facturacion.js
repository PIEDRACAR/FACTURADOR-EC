...
async function construirFacturadorParaEmisor(emisorId) {
    ...
    if (!p12Password) {
        throw new Error(`Falta la contraseña del certificado "${certificado.alias}" del emisor ${emisorId} ` +
    ...
    if (!p12Base64) {
        console.warn(`[facturacion] No se encontró ${p12Base64EnvVar}; leyendo el certificado desde disco ` +
