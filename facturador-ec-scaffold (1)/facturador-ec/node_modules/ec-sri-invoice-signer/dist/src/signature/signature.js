...
exports.signWithholdingCertificateXml = exports.signDeliveryGuideXml = exports.signCreditNoteXml = exports.signDebitNoteXml = exports.signInvoiceXml = exports.signDocumentXml = void 0;
...
const insertSignatureIntoInvoiceXml = (invoiceXml, signatureXml, rootTagName) => {
    const tagName = `</${rootTagName}>`;
    return invoiceXml.replace(tagName, `${signatureXml}${tagName}`);
};
const signDocumentXml = (docXml, pkcs12Data, rootTagName, options) => {
    ...
    (0, xml_1.validateDocumentType)(docXml);
    (0, xml_1.validateXmlFeatures)(docXml);
    // IDs
...
exports.signDocumentXml = signDocumentXml;
/**
 *
 ...
 */
const signInvoiceXml = (xml, pkcs12Data, options) => {
    return (0, exports.signDocumentXml)(xml, pkcs12Data, 'factura', options);
};
 ...
 */
const signDebitNoteXml = (xml, pkcs12Data, options) => {
    return (0, exports.signDocumentXml)(xml, pkcs12Data, 'notaDebito', options);
};
exports.signDebitNoteXml = signDebitNoteXml;
/**
 *
 ...
 */
const signCreditNoteXml = (xml, pkcs12Data, options) => {
    return (0, exports.signDocumentXml)(xml, pkcs12Data, 'notaCredito', options);
};
exports.signCreditNoteXml = signCreditNoteXml;
/**
 *
 ...
 */
const signDeliveryGuideXml = (xml, pkcs12Data, options) => {
    return (0, exports.signDocumentXml)(xml, pkcs12Data, 'guiaRemision', options);
};
exports.signDeliveryGuideXml = signDeliveryGuideXml;
/**
 *
 ...
 */
const signWithholdingCertificateXml = (xml, pkcs12Data, options) => {
    return (0, exports.signDocumentXml)(xml, pkcs12Data, 'comprobanteRetencion', options);
};
exports.signWithholdingCertificateXml = signWithholdingCertificateXml;
