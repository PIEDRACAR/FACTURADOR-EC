...
function getSearchPaths() {
  ...
  if (thisDir) {
    ...
    const candidates = [
      ...
      resolve(thisDir, "..", "..", "xsd"),
      // dist/chunk/ -> ../../xsd
      resolve(thisDir, "..", "..", "..", "..", "vendor", "sri", "xsd")
...
function findXsdFile(filename) {
  ...
  throw new Error(
    `Official SRI XSD file not found: ${filename}. Searched: ${paths.map((p) => resolve(p, filename)).join(", ")}. Ensure the xsd/ directory is present in the package or use registerXsdSearchPath().`
  );
}
...
var _require = typeof import.meta.url === "string" ? createRequire(import.meta.url) : typeof __require !== "undefined" ? __require : createRequire(__filename);
...
var soapBuilder = new XMLBuilder({
