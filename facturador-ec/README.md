# CONTSERTRIB FACTURACIÓN — v9.9.2
...
**v9.9.2 — paquete fuente consolidado.**
...
## 13. Corrección de carga de la interfaz profesional (v9.9.2)

Esta versión conserva la interfaz ejecutiva construida anteriormente y corrige un problema importante de entrega: las pantallas protegidas cargan explícitamente `public/app.css` y `public/app-shell.js`, además de la inyección del backend. Esto evita que una configuración de despliegue que no ejecute la inyección HTML deje visible la plantilla básica sin el menú lateral, barra superior y navegación profesional.
