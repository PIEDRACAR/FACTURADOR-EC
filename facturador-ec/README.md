...
El motor nuevo no fija 15% como tarifa general. Para nuevos cálculos se toma como referencia la información vigente publicada por SRI: IVA general 13%, 5% para los casos aplicables de materiales de construcción y 0% para operaciones gravadas a tarifa 0%. Los comprobantes históricos conservan su detalle tributario y no se recalculan.
