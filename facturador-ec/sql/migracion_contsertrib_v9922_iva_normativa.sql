...
-- general es 13% y el código electrónico correspondiente es 10.
update configuracion_iva
set tarifa_general=13, codigo_general='10',
...
alter table configuracion_iva alter column tarifa_general set default 13;
...
select '10','IVA general 13%',13,'TARIFA','general',date '2026-01-01',null,'Código 10 para tarifa 13% según documentación SRI del Facturador Electrónico.',true
...
-- general actual 13%. No se tocan comprobantes históricos.
