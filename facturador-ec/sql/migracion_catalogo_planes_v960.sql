...
values
('BASICO_M_50','Básico 50','Facturación electrónica de servicios.',1.49,8.49,'mensual',101,true,50,null,1,1,1,1,false,false,false,false,'50 documentos · facturación de servicios'),
('BASICO_M_100','Básico 100','Facturación electrónica de servicios.',1.99,12.49,'mensual',102,true,100,null,1,1,1,1,false,false,false,false,'100 documentos · facturación de servicios'),
('BASICO_M_250','Básico 250','Facturación electrónica de servicios.',3.49,20.49,'mensual',103,true,250,null,1,1,1,1,false,false,false,false,'250 documentos · facturación de servicios'),
('BASICO_M_500','Básico 500','Facturación electrónica de servicios.',5.99,36.99,'mensual',104,true,500,null,1,1,1,1,false,false,false,false,'500 documentos · facturación de servicios'),
...
(codigo,nombre,descripcion,precio_mensual,precio_anual,periodicidad,orden,activo,max_documentos_mes,max_documentos_anio,max_contribuyentes,max_establecimientos,max_puntos_emision,max_usuarios,incluye_inventario,incluye_ats,incluye_carga_electronica,incluye_reportes_avanzados,descripcion_comercial)
values
('EXPRESS_M_50','Express 50','Facturación electrónica + inventario.',3.49,20.49,'mensual',301,true,50,null,1,1,1,2,true,true,true,true,'50 documentos · facturación + inventario'),
('EXPRESS_M_100','Express 100','Facturación electrónica + inventario.',4.99,28.49,'mensual',302,true,100,null,1,1,1,2,true,true,true,true,'100 documentos · facturación + inventario'),
('EXPRESS_M_250','Express 250','Facturación electrónica + inventario.',6.99,40.99,'mensual',303,true,250,null,1,2,2,3,true,true,true,true,'250 documentos · facturación + inventario'),
('EXPRESS_M_500','Express 500','Facturación electrónica + inventario.',9.99,56.99,'mensual',304,true,500,null,1,2,3,5,true,true,true,true,'500 documentos · facturación + inventario'),
('EXPRESS_M_ILIMITADO','Express Ilimitado','Facturación electrónica + inventario sin límite de documentos.',14.99,80,'mensual',305,true,null,null,2,5,10,10,true,true,true,true,'Documentos ilimitados · facturación + inventario'),
...
(codigo,nombre,descripcion,precio_mensual,precio_anual,periodicidad,orden,activo,max_documentos_mes,max_documentos_anio,max_contribuyentes,max_establecimientos,max_puntos_emision,max_usuarios,incluye_inventario,incluye_ats,incluye_carga_electronica,incluye_reportes_avanzados,descripcion_comercial)
values
('POS_M_500','POS 500','Sistema comercial completo con POS, caja y bodegas.',14.99,150,'mensual',501,true,500,null,2,3,5,8,true,true,true,true,'500 documentos · POS + caja + inventario + bodegas'),
('POS_M_1000','POS 1000','Sistema comercial completo con POS, caja y bodegas.',19.99,200,'mensual',502,true,1000,null,3,5,10,15,true,true,true,true,'1.000 documentos · POS + caja + inventario + bodegas'),
('POS_M_ILIMITADO','POS Ilimitado','Sistema comercial completo sin límite de documentos.',24.99,250,'mensual',503,true,null,null,5,20,40,30,true,true,true,true,'Documentos ilimitados · POS + caja + inventario + bodegas'),
