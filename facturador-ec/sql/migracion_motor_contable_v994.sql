...
create index if not exists idx_plan_cuentas_emisor on plan_cuentas_contables(emisor_id,activa,codigo);
...
-- Valores fiscales 2026 usados por el motor: la tarifa general parametrizada para CONTSERTRIB es 15%; el motor debe consultar vigencias y no recalcular comprobantes históricos.
