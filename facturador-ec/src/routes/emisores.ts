  ...
  app.post<{ Body: SolicitudRegistroBody }>('/emisores/registrar', async (request, reply) => {
    ...
    try {
      ...
      return reply.status(201).send({
        ...
        pago: pagoAutomatico ? { estado:pagoAutomatico.estado, monto:pagoAutomatico.monto, paymentLink:pagoAutomatico.payment_link, referencia:pagoAutomatico.client_transaction_id } : { estado:'pendiente', error:pagoAutomaticoError },
