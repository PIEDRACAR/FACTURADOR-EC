...
export async function registrarRutasPos(app: FastifyInstance) {
  ...
  app.post<{ Body: VentaBody }>('/pos/venta', async (request, reply) => {
    ...
    // Validación XSD/tributaria básica ANTES de crear la venta. Si el XML es
    // obviamente inválido, no debemos descontar inventario ni dejar una venta
    // parcialmente procesada. El motor de emisión vuelve a validar después.
