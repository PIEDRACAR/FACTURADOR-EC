...
function perfilDesdeTarifa(t:string){return t==='0'?'CERO':t==='5'?'FIJA_5':t==='8'?'TURISMO':t==='exento'?'EXENTO':t==='no_objeto'?'NO_OBJETO':'GENERAL';}
  ...
  app.post<{ Body: { emisorId?: string; archivoBase64?: string } }>('/productos/importar', async (request, reply) => {
    ...
    filas.forEach((fila, indice) => {
      ...
      productosValidos.push({
        ...
        perfil_iva: perfilDesdeTarifa(tarifaIva),
        stock_actual: stock,
