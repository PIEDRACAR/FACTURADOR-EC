...
export async function registrarRutasConfiguracion(app: FastifyInstance) {
  ...
  app.patch<{ Body: { emisorId?: string; nombreComercial?: string; razonSocial?: string; direccionMatriz?: string; ambiente?: 'pruebas'|'produccion'; obligadoContabilidad?: boolean; notificacionesActivas?: boolean; actividadTuristica?: boolean; registroTurismo?: boolean; luafVigente?: boolean; numeroRegistroTurismo?: string } }>('/configuracion/guardar', async (request, reply) => {
    ...
    if (b.actividadTuristica !== undefined) cambios.actividad_turistica = Boolean(b.actividadTuristica);
    if (b.registroTurismo !== undefined) cambios.registro_turismo = Boolean(b.registroTurismo);
    if (b.luafVigente !== undefined) cambios.luaf_vigente = Boolean(b.luafVigente);
    if (b.numeroRegistroTurismo !== undefined) cambios.numero_registro_turismo = String(b.numeroRegistroTurismo).trim() || null;
