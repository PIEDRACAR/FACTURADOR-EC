...
export async function registrarRutasDocumentos(app: FastifyInstance) {
  ...
  app.get<{ Params:{id:string} }>('/api/documentos/:id/ticket', async (request, reply) => {
    try {
      ...
      const datos:any=d.datos||{}; const emisor:any=d.emisores||{};
