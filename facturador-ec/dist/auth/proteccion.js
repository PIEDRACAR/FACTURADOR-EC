...
const PAGINAS_HTML = new Set([
    ...
    '/correo-prueba', '/admin-proveedor', '/suscripcion', '/ats', '/impuestos-admin',
]);
...
export function registrarProteccionSesion(app) {
    app.addHook('preHandler', async (request, reply) => {
        ...
        if (!sesion) {
            if (metodo === 'GET' && (PAGINAS_HTML.has(patronRuta) || patronRuta === '/admin-proveedor' || patronRuta === '/impuestos-admin'))
        ...
        if (patronRuta === '/admin-proveedor' || patronRuta === '/impuestos-admin' || patronRuta === '/suscripcion' || patronRuta.startsWith('/proveedor/')) {
        ...
        if (suscripcion) {
            ...
            if (suscripcion.estado === 'activa' && suscripcion.proximo_vencimiento < hoy) {
                ...
                if (metodo === 'GET' && PAGINAS_HTML.has(patronRuta))
                    return reply.redirect(`/suscripcion?emisorId=${encodeURIComponent(emisorId)}`);
