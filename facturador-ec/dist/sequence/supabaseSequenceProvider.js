...
const COLUMNA_POR_TIPO = {
    ...
    GUIA_REMISION: 'secuencial_guia_remision',
    COMPROBANTE_RETENCION: 'secuencial_retencion',
    LIQUIDACION_COMPRA: 'secuencial_liquidacion_compra',
};
export class SupabaseSequenceProvider {
    ...
    async next(establecimiento, puntoEmision, documentType) {
        ...
        if (error) {
            throw new Error(`No se pudo obtener el siguiente secuencial (${documentType}, ` +
    ...
    async rollback(establecimiento, puntoEmision, documentType) {
        console.warn(`[SupabaseSequenceProvider] rollback solicitado para ${documentType} ` +
...
//# sourceMappingURL=supabaseSequenceProvider.js.map