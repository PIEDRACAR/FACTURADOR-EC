...
function obtenerLlave() {
    ...
    if (llave.length !== 32) {
        throw new Error(`SECRETS_ENCRYPTION_KEY debe ser una cadena hexadecimal de 32 bytes (64 caracteres). ` +
...
export function descifrarTexto(paquete) {
 ...
 */
export function bufferAPgBytea(buf) {
    return `\\x${buf.toString('hex')}`;
}
export function pgByteaABuffer(valor) {
