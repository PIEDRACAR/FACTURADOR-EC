(function () {
  ...
  const modulo = [
    ...
    ['/usuarios-admin', 'user', 'Usuarios'], ['/correo-prueba', 'mail', 'Correo'], ['/ats', 'chart', 'ATS'], ['/impuestos', 'chart', 'Impuestos'], ['/configuracion', 'settings', 'Configuración']
  ];
