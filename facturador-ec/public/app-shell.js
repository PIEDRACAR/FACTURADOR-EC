  ...
  function renderShell(negocio) {
    ...
    aside.innerHTML = `
      ...
      <nav class="ec-menu" aria-label="Navegación principal">
        ...
        <div class="ec-menu-group">${navLink(['/caja','cash','Caja'])}${navLink(['/contabilidad','chart','Contabilidad'])}${navLink(['/cuentas-por-cobrar','receive','Cuentas por cobrar'])}${navLink(['/cuentas-por-pagar','pay','Cuentas por pagar'])}${navLink(['/reportes','chart','Reportes'])}${navLink(['/ats','chart','ATS'])}</div>
