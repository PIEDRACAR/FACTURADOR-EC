...
const CODIGO_PORCENTAJE_IVA = { '0': '0', '5': '5', '8': '8', '15': '4', exento: '7', no_objeto: '6' };
const TASA_POR_TARIFA = { '0': 0, '5': 0.05, '8': 0.08, '15': 0.15, exento: 0, no_objeto: 0 };
...
export async function registrarRutasProformas(app) {
    ...
    app.post('/proformas/:id/convertir', async (request, reply) => {
        ...
        if (subtotal5 > 0)
            totalConImpuestos.push({ codigo: '2', codigoPorcentaje: '5', baseImponible: subtotal5, valor: redondear(subtotal5 * 0.05) });
        if (subtotal8 > 0)
            totalConImpuestos.push({ codigo: '2', codigoPorcentaje: '8', baseImponible: subtotal8, valor: redondear(subtotal8 * 0.08) });
        if (subtotal15 > 0)
            totalConImpuestos.push({ codigo: '2', codigoPorcentaje: '4', baseImponible: subtotal15, valor: redondear(subtotal15 * 0.15) });
        const hoy = new Date();
